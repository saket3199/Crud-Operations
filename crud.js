var crudApp = new function () {
        ...
        this.myBooks = [
            { ID: '1',Roll_No: '123456', Student_Name: 'Saket Mishra', Gender: 'Male', Standard: 'X' ,DOB:'27 Dec 1999'},
            { ID: '2',Roll_No: '123456', Student_Name: 'Saket Mishra', Gender: 'Male', Standard: 'X' ,DOB:'27 Dec 1999'},
            { ID: '3',Roll_No: '123456', Student_Name: 'Saket Mishra', Gender: 'Male', Standard: 'X' ,DOB:'27 Dec 1999'}
        ]

        this.Gender = ['Male', 'Female', 'Others'];
        this.Standard = ['i','ii','iii','iv','v','vi','vii','viii','ix','X'];
        this.col = [];
            ...
            for (var j = 0; j < this.col.length; j++) {
                ...
                if (j >= 1) {
                    ...
                    if (j == 3) {   // WE'LL ADD A DROPDOWN LIST AT THE SECOND COLUMN (FOR Category).
                        ...
                        for (k = 0; k < this.Gender.length; k++) {
                            select.innerHTML = select.innerHTML +
                                '<option value="' + this.Gender[k] + '">' + this.Gender[k] + '</option>';
                        }
                        newCell.appendChild(select);
                    }
                    else if (j == 4) {   // WE'LL ADD A DROPDOWN LIST AT THE SECOND COLUMN (FOR Category).

                        var select = document.createElement('select');      // CREATE AND ADD A DROPDOWN LIST.
                        select.innerHTML = '<option value=""></option>';
                        for (k = 0; k < this.Standard.length; k++) {
                            select.innerHTML = select.innerHTML +
                                '<option value="' + this.Standard[k] + '">' + this.Standard[k] + '</option>';
                        }
                        newCell.appendChild(select);
                    }
                    else {
